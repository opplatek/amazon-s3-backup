...
main_dir="/home/mns/workspace/projects/mouse_FUS"
bucket="mousefus-all-manolis" # Without s3://
manifest="/home/joppelt/playground/logs/s3-sync-manifest-all.log" # File to keep track of what was backed up
